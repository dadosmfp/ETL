...
type('371,375,379,678,623')
doubleClick(Pattern("1695908554959.png").similar(0.95).targetOffset(45,0))
type('24,21,22,23,50,45,9,7,18,19,30,1,40,20,51,54,56,58,59,60,61,62,66,114,115,116')
...
doubleClick(Pattern("1695908524689.png").targetOffset(48,0))
type('371,375,379,678,623')
click(Pattern("1695911468117.png").similar(0.87).targetOffset(115,0))
doubleClick(Pattern("1695908554959.png").similar(0.95).targetOffset(45,0))
type('24,21,22,23,50,45,9,7,18,19,30,1,40,20,51,54,56,58,59,60,61,62,66,114,115,116')
doubleClick(Pattern("1695911201501.png").exact().targetOffset(44,-1))
type('16,44,45,34,43,14,6,47,39,11,10,1,19,32,15,17,20,46,37,48,49,52,54,56,57,58,59,60,61,62,63,64,65,66,310')
doubleClick(Pattern("1695908579323.png").similar(0.95).targetOffset(30,-2))
type('ADT,DEV')
doubleClick(Pattern("1695908655198.png").similar(0.95).targetOffset(27,-4))
type('ADT,DEV')
...
keyDown(Key.CTRL)
click(Pattern("1696276497662.png").similar(0.97))
click(Pattern("1696276520260.png").exact())
click(Pattern("1696276570794.png").similar(0.95))
keyUp(Key.CTRL)
